...
_SETTINGS = {
	"arm64-apple-ios-simulator ShareExt.appex/ShareExt": {
		"c": "-iquote$(PROJECT_DIR) -iquote$(PROJECT_DIR)/bazel-out/ios_sim_arm64-dbg-ios-sim_arm64-min17.0-applebin_ios-ST-1d00ae144680/bin -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all"
	},
